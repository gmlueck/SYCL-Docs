...
Programming languages — {cpp}>>, referred to in this specification as the next {cpp} specification.
...
minimum number of elements in an image object is one. The minimum number
of elements in a buffer object is zero.
